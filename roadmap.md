...
- [x] Add column-format note in Import New Leads section so users know the expected Excel columns
- [x] Admin Excel download on Leads page respecting active filters (already present)
